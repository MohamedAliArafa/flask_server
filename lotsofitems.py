...
from database_setup import Shop, Base, Items
...
Items1 = Items(name="Chicken Stir Fry", description="With your choice of noodles vegetables and sauces", quantity=10,
               price="$7.99", short_description="Entree", shop=Shop2)
...
Items2 = Items(
    ...
    price="$25", quantity=10, short_description="Entree", shop=Shop2)
...
Items3 = Items(name="Spicy Tuna Roll", description="Seared rare ahi, avocado, edamame, cucumber with wasabi soy sauce ",
               quantity=10,
               price="15", short_description="Entree", shop=Shop2)
...
Items4 = Items(name="Nepali Momo ", description="Steamed dumplings made with vegetables, spices and meat. ",
               quantity=10,
               price="12", short_description="Entree", shop=Shop2)
...
Items5 = Items(name="Beef Noodle Soup",
               ...
               quantity=10,
               price="14", short_description="Entree", shop=Shop2)
...
Items1 = Items(name="Pho",
               ...
               quantity=10,
               price="$8.99", short_description="Entree", shop=Shop1)
...
Items2 = Items(name="Chinese Dumplings",
               ...
               quantity=10,
               price="$6.99", short_description="Appetizer", shop=Shop1)
...
Items3 = Items(name="Gyoza",
               ...
               quantity=10,
               price="$9.95", short_description="Entree", shop=Shop1)
...
Items4 = Items(name="Stinky Tofu", description="Taiwanese dish, deep fried fermented tofu served with pickled cabbage.",
               quantity=10,
               price="$6.99", short_description="Entree", shop=Shop1)

session.add(Items4)
session.commit()

Items2 = Items(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce", quantity=10,
               price="$9.50", short_description="Entree", shop=Shop1)
...
Items1 = Items(name="Tres Leches Cake",
               ...
               quantity=10,
               price="$2.99", short_description="Dessert", shop=Shop1)
...
Items3 = Items(name="Honey Boba Shaved Snow",
               ...
               quantity=10,
               price="$4.50", short_description="Dessert", shop=Shop1)
...
Items4 = Items(name="Cauliflower Manchurian",
               ...
               quantity=10,
               price="$6.95", short_description="Appetizer", shop=Shop1)
...
Items5 = Items(name="Aloo Gobi Burrito",
               ...
               quantity=10,
               price="$7.95", short_description="Entree", shop=Shop1)

session.add(Items5)
session.commit()

Items2 = Items(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce", quantity=10,
               price="$6.80", short_description="Entree", shop=Shop1)
...
Items1 = Items(name="Shellfish Tower",
               ...
               price="$13.95", short_description="Entree", shop=Shop1)

session.add(Items1)
session.commit()

Items2 = Items(name="Chicken and Rice", description="Chicken... and rice", quantity=10,
               price="$4.95", short_description="Entree", shop=Shop1)
...
Items3 = Items(name="Mom's Spaghetti", description="Spaghetti with some incredible tomato sauce made by mom",
               quantity=10,
               price="$6.95", short_description="Entree", shop=Shop1)
...
Items3 = Items(name="Potstickers", description="Delicious chicken and veggies encapsulated in fried dough.",
               quantity=10,
               price="$6.50", short_description="Appetizer", shop=Shop1)

session.add(Items3)
session.commit()

Items4 = Items(name="Nigiri Sampler", description="Maguro, Sake, Hamachi, Unagi, Uni, TORO!", quantity=10,
               price="$6.75", short_description="Appetizer", shop=Shop1)

session.add(Items4)
session.commit()

Items2 = Items(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce", quantity=10,
               price="$7.00", short_description="Entree", shop=Shop1)
...
Items2 = Items(name="Broiled salmon", description="Salmon fillet marinated with fresh herbs and broiled hot & fast",
               quantity=10,
               price="$10.95", short_description="Entree", shop=Shop1)
...
Items3 = Items(name="Morels on toast (seasonal)",
               ...
               price="$7.50", short_description="Appetizer", shop=Shop1)
...
Items4 = Items(name="Tandoori Chicken",
               ...
               price="$8.95", short_description="Entree", shop=Shop1)
...
Items10 = Items(name="Spinach Ice Cream", description="vanilla ice cream made with organic spinach leaves", quantity=10,
                price="$1.99", short_description="Dessert", shop=Shop1)
...
Items1 = Items(name="Super Burrito Al Pastor",
               ...
               price="$5.95", short_description="Entree", shop=Shop1)
...
Items1 = Items(name="Chantrelle Toast",
               ...
               price="$5.95", short_description="Appetizer", shop=Shop1)
...
Items1 = Items(name="Guanciale Chawanmushi", quantity=10,
               ...
               price="$6.95", short_description="Dessert", shop=Shop1)
...
Items1 = Items(name="Lemon Curd Ice Cream Sandwich",
               ...
               price="$4.25", short_description="Dessert", shop=Shop1)
